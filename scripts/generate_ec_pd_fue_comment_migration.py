...
_VALUE_COLUMNS = {
    ...
    "peak_datetime": "Дата и время максимума потребления мощности",
    ...
    "electrical_intensity_kvt_ch_per_person": "Электроёмкость, кВтч/чел.",
    "population_thousand_persons": "Численность населения, тыс. чел.",
    "population_consumption_mln_kvt_ch": "Потребление населения, млн кВтч",
    ...
    "betp": "Сумма теплофикационной выработки ЭЭ, тыс.кВтч, базовый год",
    "bq": "Сумма отпуска ТЭ, тыс.Гкал (Q), базовый год",
    "bqotr": "Сумма теплового потребления (отборов турбин), тыс.Гкал, базовый год",
    ...
    "cetp": "Сумма теплофикационной выработки ЭЭ, тыс.кВтч, расчётный год",
    "cq": "Сумма отпуска ТЭ, тыс.Гкал (Q), расчётный год",
    "cqotr": "Сумма теплового потребления (отборов турбин), тыс.Гкал, расчётный год",
    ...
    "potr": "Отношение теплового потребления (отборов турбин) (расчётный/базовый год)",
