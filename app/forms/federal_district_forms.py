...
class FederalDistrictFilter(FlaskForm):
    """Форма фильтрации и управления списком ФО"""
    csrf_token = HiddenField()

    federal_district_ids = HiddenField("ID")
    ...
    name_full = StringField(
        'Наименование ФО',
        validators=[
            DataRequired(message="Поле 'Наименование полное ФО' обязательно для заполнения."),
            Length(min=2, max=255, message="Длина имени должна быть от 2 до 255 символов.")
        ]
    )
    ...
    name_abr = StringField(
        'Наименование ФО',
        validators=[
            DataRequired(message="Поле 'Наименование сокращенное ФО' обязательно для заполнения."),
            Length(min=2, max=255, message="Длина имени должна быть от 2 до 255 символов.")
        ]
    )
...
class AddFederalDistrict(FlaskForm):
...
class FileUploadFederalDistrictrm(FlaskForm):
