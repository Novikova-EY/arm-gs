...
from app.refdata.forms.gen_company_forms import GenCompanyFilterForm, AddGenCompanyForm
...
@reference_bp.route("/gen_company", methods=["GET", "POST"])
def gen_company_list():
    ...
    if request.method == "POST":
        ...
        if gen_company_delete:
            ...
            return redirect(url_for("reference_bp.gen_company_list", 
                                    page=page, 
                                    per_page=per_page, 
...
@reference_bp.route("/add_gen_company", methods=["GET", "POST"])
...
@reference_bp.route("/import_gen_company_to_sql", methods=["POST"])
...
@reference_bp.route("/export_gen_company_to_excel", methods=["GET"])
