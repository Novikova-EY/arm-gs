...
from app.refdata.services.refdata_for_stations.machines.tes_machine_type_services import (
    ...
    update_tes_machine_type_all_versions_service, 
    add_tes_machine_type_service, 
    add_tes_machine_type_all_versions_service, 
...
def tes_machine_type_list():
    ...
    tes_machine_type_filter    = _normalize_filter(request.args.get("tes_machine_type_filter"))
    ...
    if request.method == "POST":       
        ...
        tes_machine_type_filter    = _normalize_filter(request.form.get("tes_machine_type_filter"))
        ...
        tes_machine_type_orders    = request.form.getlist("display_orders[]")
        ...
        try:
           ...
           # Формирование данных для обновления
            ...
            for tes_machine_type_id, tes_machine_type_name, display_order in zip(
                tes_machine_type_ids, tes_machine_type_names, tes_machine_type_orders
            ):
                ...
                try:
                    ...
                    raise ValueError(
                        (
                            f"Ошибка обработки порядка отображения для записи c ID={tes_machine_type_id}: "
            ...
            if request.values.get("all_versions") == "1":
                ...
                update_tes_machine_type_all_versions_service(tes_machine_type_data, user)
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if request.values.get("all_versions") == "1":
                ...
                add_tes_machine_type_all_versions_service(payload, user)
