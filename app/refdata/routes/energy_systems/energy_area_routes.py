...
# Формы
from app.refdata.forms.energy_systems.energy_area_forms import EnergyAreaFilterForm, AddEnergyAreaForm
...
from app.refdata.services.energy_systems.energy_area_services import (
    ...
    export_energy_area_to_excel_service, 
)
...
def add_energy_area_routes():
    ...
    if request.method == "POST":
        ...
        try:
            ...
            new_energy_area_id = add_energy_area_service([
                {
                    "name": form.name.data,
...
def export_energy_area_to_excel_routes():
    ...
    try:
        ...
        excel_data = export_energy_area_to_excel_service(user, energy_area_filter, regional_district_filter, regional_energy_system_filter, union_energy_system_filter, sort_by, sort_dir)
