...
# Формы
from app.refdata.forms.energy_systems.union_energy_system_forms import UnionEnergySystemFilterForm, AddUnionEnergySystemForm
...
from app.refdata.services.energy_systems.union_energy_system_services import (
    ...
    get_total_union_energy_system_records,
    update_union_energy_system_service, 
    add_union_energy_system_service, 
    delete_union_energy_system_service,
    import_union_energy_system_from_excel_service, 
    export_union_energy_system_to_excel_service, 
)
   ...
   # Обработка формы
    if request.method == "POST" and form.validate_on_submit():
        try:
            ...
            new_union_energy_system_id = add_union_energy_system_service([{
...
@refdata_bp.route("/import_union_energy_system_to_sql", methods=["POST"])
def import_union_energy_system_to_sql_routes():
    ...
    try:
        imported_count = import_union_energy_system_from_excel_service(file, user)
...
@refdata_bp.route("/export_union_energy_system_to_excel", methods=["GET"])
def export_union_energy_system_to_excel_routes():
    ...
    try:
        ...
        excel_data = export_union_energy_system_to_excel_service(user, union_energy_system_filter, energy_system_type_filter, sort_by, sort_dir)
