...
from app.refdata.forms.energy_area_forms import EnergyAreaFilterForm, AddEnergyAreaForm
from app.refdata.services.energy_area_services import (
...
@reference_bp.route("/energy_areas", methods=["GET", "POST"])
def energy_area_list():
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("reference_bp.energy_area_list",
                                page=page,
                                per_page=per_page,
...
@reference_bp.route("/add_energy_area", methods=["GET", "POST"])
...
@reference_bp.route("/export_energy_area_to_excel", methods=["GET"])
