...
from app.refdata.forms.fuel_forms import OesFilterForm, AddOesForm
from app.refdata.services.fuel_services import (
...
@reference_bp.route("/fuel", methods=["GET", "POST"])
def fuel_list():
    ...
    if request.method == "POST":       
        ...
        if fuel_delete:
            ...
            return redirect(url_for("reference_bp.fuel_list", 
                                    page=page, 
                                    per_page=per_page, 
...
@reference_bp.route("/add_fuel", methods=["GET", "POST"])
def add_fuel_routes():
    """
...
@reference_bp.route("/import_fuel_to_sql", methods=["POST"])
...
@reference_bp.route("/export_fuel_to_excel", methods=["GET"])
