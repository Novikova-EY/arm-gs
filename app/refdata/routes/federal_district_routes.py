...
from app.refdata.forms.federal_district_forms import FederalDistrictFilter, AddFederalDistrict
from app.refdata.services.federal_district_services import (
    get_federal_district_list, 
    update_federal_district, 
    add_federal_district, 
    delete_federal_district_list,
    import_federal_district_from_excel, 
    export_federal_district_to_excel, 
...
@reference_bp.route("/federal_district", methods=["GET", "POST"])
def federal_district_list():
    ...
    if request.method == "POST":
        ...
        if federal_district_delete:
            ...
            return redirect(url_for("reference_bp.federal_district_list", 
                                    page=page, 
                                    per_page=per_page, 
...
@reference_bp.route("/add_federal_district", methods=["GET", "POST"])
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return redirect(url_for(
                "reference_bp.federal_district_list",
                sort_by=sort_by,
                sort_dir=sort_dir,
                federal_district_filter=federal_district_filter,
                per_page=per_page,
...
@reference_bp.route("/import_federal_district_to_sql", methods=["POST"])
...
@reference_bp.route("/export_federal_district_to_excel", methods=["GET"])
