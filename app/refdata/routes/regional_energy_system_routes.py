...
from app.refdata.forms.regional_energy_system_forms import RegionalEnergySystemFilterForm, AddRegionalEnergySystemForm
from app.refdata.services.regional_energy_system_services import (
    get_regional_energy_system_list, 
    get_union_energy_system, 
    update_regional_energy_system, 
    add_regional_energy_system, 
    delete_regional_energy_system_list, 
    get_regional_districts,
    import_regional_energy_system_from_excel, 
    export_regional_energy_system_to_excel, 
    get_total_with_filter
)

@reference_bp.route("/regional_energy_system", methods=["GET", "POST"])
def regional_energy_system_list():
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("reference_bp.regional_energy_system_list",
                                page=page,
                                per_page=per_page,
...
@reference_bp.route("/add_regional_energy_system", methods=["GET", "POST"])
    ...
    if request.method == "POST":
        ...
        try:
            ...
            return redirect(url_for(
                "reference_bp.regional_energy_system_list",
                sort_by=sort_by,
                sort_dir=sort_dir,
                regional_energy_system_filter=regional_energy_system_filter,
                union_energy_system_filter=union_energy_system_filter,
...
@reference_bp.route("/import_regional_energy_system_to_sql", methods=["POST"])
...
@reference_bp.route("/export_regional_energy_system_to_excel", methods=["GET"])
