...
def import_regional_energy_system_from_excel_service(file, user):
...
def export_regional_energy_system_to_excel_service(user, regional_energy_system_filter=None, union_energy_system_filter=None, sort_by="id", sort_dir="asc"):
