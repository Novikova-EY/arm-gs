...
PD_FORMULA_TEMPLATE_VAR_KEYS: dict[str, str] = {
    ...
    "_pd_fo_calc_max_power_mw_formula": "fo_calc_max_power_mw",
    "_pd_fo_calc_combined_on_cz_mw_formula": "fo_calc_combined_on_cz_mw",
    "_pd_fo_calc_combined_on_cz_mw_coeff_formula": "fo_calc_combined_on_cz_mw_coeff",
    ...
    "_pd_fo_verify_combined_on_cz_mw_coeff_formula": "fo_verify_combined_on_cz_mw_coeff_without_nt",
