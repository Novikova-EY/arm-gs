...
from . import app_bp
from app.forms.regional_district_forms import RegionalDistrictFilterForm, AddRegionalDistrictForm
from app.services.reference_services.regional_district_services import (
...
def regional_district_list():
    ...
    if request.method == "POST":
        ...
        if regional_district_delete:
            ...
            return redirect(url_for("app_bp.regional_district_list", 
                                    page=page, 
                                    per_page=per_page, 
...
@app_bp.route("/add_regional_district", methods=["GET", "POST"])
...
@app_bp.route("/import_regional_district_to_sql", methods=["POST"])
...
@app_bp.route("/export_regional_district_to_excel", methods=["GET"])
