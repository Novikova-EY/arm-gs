...
@app_bp.route("/energy_units", methods=["GET", "POST"])
def energy_unit_list():
    ...
    if request.method == "POST":
        ...
        return redirect(url_for("app_bp.energy_unit_list",
                                page=page,
                                per_page=per_page,
...
@app_bp.route("/add_energy_unit", methods=["GET", "POST"])
...
@app_bp.route("/export_energy_unit_to_excel", methods=["GET"])
