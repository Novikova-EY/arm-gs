...
def union_energy_system_list():
    ...
    if request.method == "POST":        
        ...
        if union_energy_system_delete:
            ...
            return redirect(url_for("app_bp.union_energy_system_list", 
                                    page=page, 
                                    per_page=per_page, 
...
@app_bp.route("/add_union_energy_system", methods=["GET", "POST"])
    ...
    if request.method == "POST" and form.validate_on_submit():
        try:
            ...
            return redirect(url_for(
                "app_bp.union_energy_system_list",
                sort_by=sort_by,
                sort_dir=sort_dir,
                union_energy_system_filter=union_energy_system_filter,
                energy_system_type_filter=energy_system_type_filter,
...
@app_bp.route("/import_union_energy_system_to_sql", methods=["POST"])
...
@app_bp.route("/export_union_energy_system_to_excel", methods=["GET"])
