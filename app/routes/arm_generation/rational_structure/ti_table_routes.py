...
from app.models import Station, Machine, MachineTesType, RegionalDistrict
...
from sqlalchemy.orm import joinedload
from app.models import Station, Machine, EquipmentGroup, MachinePower, db
import pandas as pd
    ...
    try:
        ...
        for index, row in df.iterrows():
            ...
            try:
                ...
                eq_group = EquipmentGroup.query.filter_by(name=group_name).first()
                if not eq_group:
