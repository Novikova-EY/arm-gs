"""Страница /energy_consumption/summary/federal_districts/gaes_charge/."""
...
PAGE_TEMPLATE = "energy_consumption/pages/summary_fo_gaes_charge.html"


def build_summary_fo_gaes_charge_page_context(
    rounding_digits: int,
    *,
    start_year: int,
    end_year: int,
