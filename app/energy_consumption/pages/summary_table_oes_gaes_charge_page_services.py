"""Страница /energy_consumption/summary_table/oes/gaes_charge/."""
...
PAGE_TEMPLATE = "energy_consumption/pages/summary_table_oes_gaes_charge.html"


def build_summary_table_oes_gaes_charge_page_context(
    rounding_digits: int,
    *,
    start_year: int,
    end_year: int,
