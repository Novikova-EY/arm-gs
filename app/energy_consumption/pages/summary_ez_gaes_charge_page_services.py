"""Страница /energy_consumption/summary/energy_zones/gaes_charge/."""
...
PAGE_TEMPLATE = "energy_consumption/pages/summary_ez_gaes_charge.html"


def build_summary_ez_gaes_charge_page_context(
    rounding_digits: int,
    *,
    start_year: int,
    end_year: int,
