# -*- coding: utf-8 -*-
"""Параметры потребления для ЕЭС России (с НТ)."""
...
class EesRussiaWithNtEnergyConsumptionParameter(db.Model, AuditMixin):
    __tablename__ = "gs_ec_ees_russia_with_nt_consumption_params"
    ...
    def __repr__(self) -> str:
        return (
            f"<EesRussiaWithNtEnergyConsumptionParameter(ec) id={self.id} "
