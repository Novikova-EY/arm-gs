# -*- coding: utf-8 -*-
"""Параметры потребления для региональной энергосистемы."""
...
class RegionalEnergySystemEnergyConsumptionParameter(db.Model, AuditMixin, PerimeterVariantColumnMixin):
    __tablename__ = "gs_ec_regional_energy_system_consumption_params"
    ...
    def __repr__(self) -> str:
        return (
            f"<RegionalEnergySystemEnergyConsumptionParameter(ec) id={self.id} "
