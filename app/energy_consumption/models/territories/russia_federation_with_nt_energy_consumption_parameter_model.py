# -*- coding: utf-8 -*-
"""Параметры потребления для РФ с НТ (агрегат)."""
...
class RussiaFederationWithNtEnergyConsumptionParameter(db.Model, AuditMixin):
    __tablename__ = "gs_ec_russia_federation_with_nt_consumption_params"
    ...
    def __repr__(self) -> str:
        return (
            f"<RussiaFederationWithNtEnergyConsumptionParameter(ec) id={self.id} "
