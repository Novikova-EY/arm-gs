...
from app.energy_consumption.electrical_intensity.services.formula_text.long_term_consumption_formula_text_services import (
...
def _render_electrical_intensity_formulas_page():
    ...
    return render_template(
        "energy_consumption/electrical_intensity/electrical_intensity_formulas.html",
