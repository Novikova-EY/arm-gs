# -*- coding: utf-8 -*-
"""Накопленные Накопленные инвестиции в основной капитал по ВЭД для РФ в целом (долгосрочный прогноз)."""
...
class RussiaFederationAccumFixedCapitalParameter(db.Model, AuditMixin):
    __tablename__ = "gs_ekp_russia_federation_accum_fixed_capital_params"
    __table_args__ = (
    ...
    year = db.relationship(
        "Year",
        back_populates="rf_economic_activity_accum_fixed_capital_parameters",
        lazy="noload",
    )
    ...
    def __repr__(self) -> str:
        return (
            f"<RussiaFederationAccumFixedCapitalParameter id={self.id} "
