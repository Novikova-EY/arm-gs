# -*- coding: utf-8 -*-
"""Потребление ЭЭ по ВЭД для федерального округа (долгосрочный прогноз)."""
...
class FederalDistrictEATConsumptionParameter(db.Model, AuditMixin):
    __tablename__ = "gs_ekp_federal_district_eat_consumption_params"
    __table_args__ = (
        db.ForeignKeyConstraint(
            ...
            ondelete="RESTRICT",
            name="fk_ekp_fd_eat_cons_year_ver",
        ),
    ...
    year = db.relationship(
        "Year",
        back_populates="fd_economic_activity_consumption_parameters",
        lazy="noload",
    )
    ...
    def __repr__(self) -> str:
        return (
            f"<FederalDistrictEATConsumptionParameter id={self.id} "
