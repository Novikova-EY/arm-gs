# -*- coding: utf-8 -*-
"""Экспорт таблицы накопленных инвестиций в основной капитал в Excel."""
...
def build_accum_fixed_capital_excel_stream(context: dict[str, Any]) -> BytesIO:
    wb = Workbook()
    ws = wb.active
    ws.title = "Накопленные Накопленные инвестиции в основной капитал"
