...
FUEL_FORMULA_REGISTRY: tuple[FuelFormulaDef, ...] = (
    ...
    _def(
        ...
        cell_name="E (b_e)",
        default_text=(
            "Сумма выработки ЭЭ, млн кВтч (поле e топливных параметров групп) за базовый год — столбец «E»."
        ),
        map_key="b_e",
        map_name="coeff",
    ),
    _def(
        ...
        default_text=(
            ...
            "см. в колонке «Выработка ЭЭ, млн кВтч» (e) таблицы параметров распределения."
        ),
        map_key="c_e",
        map_name="coeff",
    ),
