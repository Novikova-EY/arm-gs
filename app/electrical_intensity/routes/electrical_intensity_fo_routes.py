...
from app.electrical_intensity.routes.electrical_intensity_route_helpers import (
    csrf,
    csrf_ok,
...
from app.electrical_intensity.services.electrical_intensity_import_services import (
...
def electrical_intensity():
    ...
    return render_template("electrical_intensity/electrical_intensity.html", **context)
