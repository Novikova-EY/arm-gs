# -*- coding: utf-8 -*-
"""Показатели блока «Население» по годам для федерального округа."""
...
class FederalDistrictPopulationConsumptionYearParameter(db.Model, AuditMixin):
    __tablename__ = "gs_ei_federal_district_population_consumption_year_params"
    __table_args__ = (
        db.ForeignKeyConstraint(
            ...
            ondelete="RESTRICT",
            name="fk_ei_fd_pop_cons_y_year_ver",
        ),
    ...
    def __repr__(self) -> str:
        return (
            f"<FederalDistrictPopulationConsumptionYearParameter id={self.id} "
            f"fd={self.id_federal_district} kind={self.row_kind} year={self.year_number}>"
        )
