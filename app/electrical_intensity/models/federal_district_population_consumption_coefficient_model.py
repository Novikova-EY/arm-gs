# -*- coding: utf-8 -*-
"""Коэффициенты A и X блока «Население» на странице электроёмкости (ФО)."""
...
class FederalDistrictPopulationConsumptionCoefficient(db.Model, AuditMixin):
    __tablename__ = "gs_ei_federal_district_population_consumption_coefficients"
    ...
    def __repr__(self) -> str:
        return (
            f"<FederalDistrictPopulationConsumptionCoefficient id={self.id} "
            f"fd={self.id_federal_district}>"
        )
