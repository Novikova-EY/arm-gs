...
EI_VED_CONSUMPTION_PLAN_FORMULA_TOOLTIP = (
    ...
    "млн кВт·ч (выпуск — млн руб., электроёмкость — кВт·ч/тыс. руб.). "
...
EI_FD_TOTAL_NETWORK_LOSSES_PLAN_FORMULA_TOOLTIP = (
    "Потери в сетях для годов «план» = Потребление ЭЭ ВЭД × k, млрд кВт·ч. "
...
EI_FD_TOTAL_POWER_STATION_PLAN_FORMULA_TOOLTIP = (
    "С.н. электростанций для годов «план» = Потребление ЭЭ ВЭД × k, млрд кВт·ч. "
