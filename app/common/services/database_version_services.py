...
def add_version_service(data, user):
    ...
    try:
        ...
        for new_version_id, parent_id in zip(created_ids, parent_version_ids):
            if parent_id:
                try:
...
def _copy_version_data_staged(source_version_id, target_version_id, user, do_commit=True):
    """
...
def get_current_version():
    ...
    # Если активной версии нет, возвращаем None (работаем со всеми данными)
    return None
