# -*- coding: utf-8 -*-
"""Ручной ввод строки «Экспорт электрической энергии» на страницах баланса ЭЭ."""
...
class EeBalanceExportValue(db.Model, AuditMixin):
    __tablename__ = "gs_bem_ee_balance_export_values"
    __table_args__ = (
        Index("ix_gs_bem_eb_exp_sheet", "sheet_slug"),
        Index("ix_gs_bem_eb_exp_year", "year_number"),
        Index("ix_gs_bem_eb_exp_dbver", "database_version_id"),
        Index(
            "uq_gs_bem_eb_exp_sheet_year_ver",
            "sheet_slug",
            "year_number",
