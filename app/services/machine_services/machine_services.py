...
from app.forms.machine_forms import MachineFilterForm, EditMachineForm, PGUMachineFilterForm
...
def handle_pgu_machine_get(station_id, machine_id, pgu_machine_id, start_year, end_year):
    ...
    from app.services.machine_services.machine_services import _fill_pgu_machines_form_choices
