...
from wtforms import StringField, SelectField, TextAreaField, HiddenField, SelectMultipleField, SubmitField
...
class StationPowerChangeFilterForm(FlaskForm):
    ...
    event_type_filter = SelectMultipleField(
        "Мероприятие",
        choices=[
            ("Ввод", "Ввод в эксплуатацию"),
            ("Вывод", "Вывод из эксплуатации"),
            ("До модернизации","До модернизации"),
            ("После модернизации","После модернизации"),
            ("Изменение мощности","Изменение мощности"),
        ],
        validators=[Optional()],
    )
