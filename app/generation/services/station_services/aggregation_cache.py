...
# v13: эффективная СЗ по году (Калининград 2021–2024 в 1 СЗ, Таймыр не в 1 СЗ)
# v14: Таймыр/Норильск определяются также по РЭС/ОЭС/энергоузлу (субъект часто «Красноярский край»)
AGGREGATION_CACHE_KEY_VERSION = 14
