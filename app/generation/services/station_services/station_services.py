...
from sqlalchemy import and_, func, select, or_, literal
from collections import defaultdict
...
def get_station_list_data(
    ...
    if show_all:
        ...
        result["aggregate_energy_units_by_station_type_with_fuel"] = aggregate_energy_units_by_station_types_with_fuel(rows)
