...
def test_apply_gaes_without_charge_formula_uses_south_charge_row_alias():
    years = [2024]
    ...
    target_row = _south_variant_row(service.CODE_WITHOUT_NT_WITHOUT_GAES, "0.0")
...
def test_consumption_mln_rows_respect_rounding_digits_from_url():
    ...
    parameter_maps, _ = service._build_parameter_maps(
