"""Формы для справочника «Типы агрегатов (MachineType)».
"""
...
class MachineTypeFilterForm(FlaskForm):
    ...
    # Фильтр
    machine_type_filter = StringField(
...
class AddMachineTypeForm(FlaskForm):
    csrf_token = HiddenField()
