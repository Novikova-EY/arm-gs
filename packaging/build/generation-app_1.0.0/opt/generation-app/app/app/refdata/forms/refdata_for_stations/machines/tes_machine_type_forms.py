"""Формы для справочника «Типы агрегатов ТЭС (TesMachineType)».
"""
...
class TesMachineTypeFilterForm(FlaskForm):
    ...
    name = StringField(
        "Тип агрегата ТЭС",
        validators=[
            DataRequired(message="Поле «Тип агрегата ТЭС» обязательно."),
    ...
    tes_machine_type_filter = StringField(
        ...
        render_kw={"placeholder": "Поиск по типам агрегатов ТЭС"},
    )
...
class AddTesMachineTypeForm(FlaskForm):
    csrf_token = HiddenField()
