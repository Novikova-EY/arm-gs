...
def energy_system_type_query(
    ...
    query = apply_version_filter(query, EnergySystemType)
    ...
    with db.session.no_autoflush:
        for record in data:
           ...
           # Проверки на валидность данных
            ...
            if name != (obj.name or ""):
                q = (apply_version_filter(EnergySystemType.query, EnergySystemType)
    ...
    def _do_insert():
        with db.session.no_autoflush:
            ...
            for record in data:
                ...
                dup = (apply_version_filter(EnergySystemType.query, EnergySystemType)
                        .filter(EnergySystemType.name == name)
