# -*- coding: utf-8 -*-
"""Таблица сводной выработки ЭЭ по ЭСПП в разрезе РЭС (млн кВт·ч).
...
SCHEMA_GEN = "gs_gen"
SCHEMA_REF = "gs_sys"
TABLE = "gs_gen_espp_energy_generations"
UNIQUE_INDEX = "uq_espp_energy_gen_res_year_month_ver"
RES_YEAR_MONTH_INDEX = "ix_espp_energy_gen_res_year_month"
MONTH_INDEX = "ix_espp_energy_gen_month_number"
YEAR_INDEX = "ix_espp_energy_gen_year_number"
RES_INDEX = "ix_espp_energy_gen_id_regional_energy_system"
...
def upgrade():
    ...
    op.create_foreign_key(
        "fk_espp_energy_gen_regional_energy_system",
        TABLE,
    ...
    op.create_foreign_key(
        "fk_espp_energy_gen_database_version",
        TABLE,
        ref_versions,
        ["database_version_id"],
        ["id"],
