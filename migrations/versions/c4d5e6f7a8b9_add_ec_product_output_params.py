# -*- coding: utf-8 -*-
"""Таблицы накопленного выпуска продукции по ВЭД (ФО и РФ).
...
TABLE_FD = "gs_ec_federal_district_economic_activity_product_output_params"
TABLE_RF = "gs_ec_russia_federation_economic_activity_product_output_params"
TABLE_FORMULA = "gs_ec_long_term_product_output_formula_texts"
VALUE_COL = "accumulated_product_output_mln_rub"
...
def upgrade():
    ...
    if not _table_exists(conn, SCHEMA_EC, TABLE_FORMULA):
        op.create_table(
            ...
            sa.UniqueConstraint("formula_key", name="uq_gs_ec_lt_po_formula_texts_key"),
            schema=SCHEMA_EC,
        )
        op.create_index(
            "ix_gs_ec_lt_po_formula_key",
            TABLE_FORMULA,
            ["formula_key"],
            unique=False,
            schema=SCHEMA_EC,
