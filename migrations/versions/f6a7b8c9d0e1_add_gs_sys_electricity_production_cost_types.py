# -*- coding: utf-8 -*-
"""Справочник затрат на производство и реализацию электрической энергии (мощности).
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("name", name="uq_gs_sys_electricity_production_cost_types_name"),
        schema=SCHEMA_REF,
    )
    op.create_index(
        "ix_gs_sys_electricity_production_cost_types_name",
        TABLE,
        ["name"],
        unique=False,
        schema=SCHEMA_REF,
    ...
    op.create_index(
        "ix_gs_sys_electricity_production_cost_types_ref_uuid",
        TABLE,
        ["ref_uuid"],
        unique=False,
        schema=SCHEMA_REF,
    ...
    op.create_index(
        "ix_gs_sys_electricity_production_cost_types_database_version_id",
        TABLE,
        ["database_version_id"],
        unique=False,
        schema=SCHEMA_REF,
    ...
    op.create_foreign_key(
        "fk_gs_sys_electricity_production_cost_types_database_version",
        TABLE,
        ref_versions,
        ["database_version_id"],
        ["id"],
