# -*- coding: utf-8 -*-
"""Обновить комментарии bk / bk_calc в gs_fue_equipment_group_specific_fuel_consumption.
...
COMMENT = "УРУТ на отпуск ЭЭ в конденсационном режиме, г у.т./кВтч"
OLD_COMMENT = "Удельный расход усл.топлива на отпуск эл.эн. в конд.режиме"
COLUMNS = ("bk", "bk_calc")
