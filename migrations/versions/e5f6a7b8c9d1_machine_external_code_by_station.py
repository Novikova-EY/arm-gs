"""Machine.external_code: station + machine_number + (name or date_exploitation)

Revision ID: e5f6a7b8c9d1
Revises: c3d4e5f6a7b9
Create Date: 2026-02-19 14:00:00.000000

Machine.external_code формируется из: external_code электростанции + machine_number
+ (machine_name или date_exploitation). date_exploitation предпочтительнее при наличии.
"""
