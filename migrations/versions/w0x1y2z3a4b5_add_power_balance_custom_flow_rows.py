...
ROWS_TABLE = "gs_bem_power_balance_custom_flow_rows"
VALUES_TABLE = "gs_bem_power_balance_custom_flow_values"
...
def upgrade():
    ...
    op.execute(
        sa.text(
            f'CREATE UNIQUE INDEX uq_gs_bem_pb_cfv_row_year_ver '
