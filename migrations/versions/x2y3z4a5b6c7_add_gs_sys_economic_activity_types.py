# -*- coding: utf-8 -*-
"""Справочник видов экономической деятельности (ВЭД).
...
def upgrade():
    ...
    op.create_index(
        "ix_gs_sys_economic_activity_types_name",
        TABLE,
        ["name"],
        unique=False,
        schema=SCHEMA_REF,
    ...
    op.create_index(
        "ix_gs_sys_economic_activity_types_ref_uuid",
        TABLE,
        ["ref_uuid"],
        unique=False,
        schema=SCHEMA_REF,
    ...
    op.create_index(
        "ix_gs_sys_economic_activity_types_database_version_id",
        TABLE,
        ["database_version_id"],
        unique=False,
        schema=SCHEMA_REF,
    ...
    op.create_foreign_key(
        "fk_gs_sys_economic_activity_types_database_version",
        TABLE,
        ref_versions,
        ["database_version_id"],
        ["id"],
